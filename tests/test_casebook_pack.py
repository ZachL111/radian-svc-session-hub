"""Regression checks for the radian-svc-session-hub casebook."""
...
from casebook.harness import assert_expected, radian_svc_session_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_svc_session_hub_summary(), assert_expected())
